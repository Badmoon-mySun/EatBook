...
<@common.bootstrap_common "Tables" "/static/css/tables.css" "/static/js/tables4.js">
            ...
            <form action="${uri}" method="post">
                ...
                <div id="${table.number}" class="table">
                    ...
                    <div class="block3">
                        ...
                        <button type="submit" style="margin-left: 20px; margin-top: 20px; font-size: 18px; border-radius: 10px">Забронировать столик</button>
                    </div>
                </div>
            </form>
        </#list>
